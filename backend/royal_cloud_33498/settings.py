"""
Django settings for royal_cloud_33498 project.
...
ROOT_URLCONF = 'royal_cloud_33498.urls'
...
WSGI_APPLICATION = 'royal_cloud_33498.wsgi.application'
...
SENDGRID_SENDER_IDENTITY = env.str("SENDGRID_SENDER_IDENTITY", "")
